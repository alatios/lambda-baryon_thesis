...
[@todo: combinatorial predominante, quindi serve un classificatore per discriminare il segnale dal fondo basandosi su variabili cinematiche]
...
Performance of the decision tree can be enhanced with \textit{boosting} \cite{Yann:2013}
...
Qui di' che hai considerato balance vs. unbalanced, optando per la prima perché tanto le performance erano le stesse.

Di' che variabili hai usato.
