...
%% Uncomment this for "digital" thesis with hyperlinks
\usepackage{pdfx}			% Let's PDF/A it from the start
%% Uncomment this for "printing" thesis without hyperlinks
...
\include{tex_files/0d-conclusion}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\appendix
%\include{tex_files/99-app-angular_distribution}ù
\include{tex_files/97-app-prefilter_selections}
\include{tex_files/96-app-bdt_features}
