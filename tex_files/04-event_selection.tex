...
\begin{figure}[t]
	...
	\begin{subfigure}{.45\textwidth}
		...
		\caption{}
	\end{subfigure}
	\caption{Distribution of simulated \demonstratorshort signal events with $z_\Lambda^\text{VF} \geq \SI{7.0}{\meter}$, as function of true (\textit{left}) and reconstructed (\textit{right}) $y_\Lambda^\text{vtx}$ and $z_\Lambda^\text{vtx}$. This corresponds to a side view of true and reconstructed \lz decay vertices.}
\end{figure}
...
\begin{figure}[t]
	...
	\begin{subfigure}{.45\textwidth}
		...
		\caption{}
	\end{subfigure}
	\caption{Distribution of simulated \demonstratorshort events with $z_\Lambda^\text{VF} - z_\Lambda^\text{true} \geq \SI{2.0}{\meter}$ as function of true \textit{(a)} and reconstructed \textit{(b)} $x_\Lambda^\text{vtx}$ and $z_\Lambda^\text{vtx}$. This corresponds to a top view of true and reconstructed \lz decay vertices.}
\end{figure}
