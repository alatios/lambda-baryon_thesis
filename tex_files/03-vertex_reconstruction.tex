...
For these reasons, the studies in the following sections were conducted on a smaller sample of [@todo:how\_many] \lbz decays in $\sign{B_y} = +1$ configuration, where $\vec{B}$ is the LHCb magnetic field.
...
As proof of concept, I have analyzed the performance of the $\sigma$-rescaled refit approach with $s_i=0.98, i\in\{x,y,z\}$ (corresponding to $\approx 2\%$ increase in vertex uncertainties) on the sample of [@todo:how many] MC-generated \demonstratorshort events previously used in this chapter, and observed a $+26.4\%$ increase in reconstructed events.
