...
Only arising when working with T tracks, as other track types come from particles produced upstream of the magnet, this problem is under-researched due to the historical rare employment of T tracks in physics analyses.
...
As a proof-of-concept exploratory study, I computed angular resolutions 
[@todo:l'ultima figura e considerazioni finali]