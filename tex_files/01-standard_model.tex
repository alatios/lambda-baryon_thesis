...
%The gauge principle accounts for the introduction of three fundamental forces and their gauge bosons.
%The first is the strong nuclear force, responsible for the binding of both quarks inside baryons and nucleons inside atomic nuclei. The related theory, quantum chromodynamics (QCD), is obtained by imposing a local gauge invariance under a $\text{SU(3)}$ symmetry group, which has the side-effect of introducing the strong gauge boson, the gluon.
