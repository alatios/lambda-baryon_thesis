...
Quantum chromodynamics (QCD), the theory for the strong nuclear force, is based on a separate $\text{SU(3)}_C$ symmetry acting on the three-dimensional space of color charges.

There is no gauge boson nor gauge theories associated to the fourth known fundamental force, gravity.
