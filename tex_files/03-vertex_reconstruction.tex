...
Comparing Figures \ref{fig:pim_refpoint_residual_2Dv3D_x_rel_matter} and \ref{fig:pim_refpoint_residual_2Dv3D_x_rel_antimatter}, pion reference points $x$ in non-converged events show opposite bias when extrapolated at the $\Lambda^0$ vertex.
...
Furthermore, a lower $p_z$ will affect the closest distance point between proton and pions in the $zx$ plane, but will have no bearing on the track crossing point in the $yz$ plane, where bending is negligible, supporting the conflicting information interpretation for vertex oscillation given in Section \ref{sec:oscillation}.
