...
The polarization given by the equation of motion derived in Section \ref{sec:emdm-measurement} refers to the comoving rest frame of the $\Lambda^0$ (also known as the \textit{canonical frame)}, related to the $\text{S}_\text{L}$ frame by a Lorentz boost.
