...
Where algorithm performances truly diverge is in \textit{exclusive} events, i.e. events only reconstructed by one particular algorithm.
...
for instance, an event that only converges with the $\sigma_z$-rescaled algorithm must have subpar information for the $xz$ and $yz$ planes (preventing convergence with VF, $\sigma_x$- and $\sigma_y$-rescaled algorithms) %@todo
