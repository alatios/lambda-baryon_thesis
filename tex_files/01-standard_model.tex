...
\right).
\end{align}
Assuming $\vec{E} = 0$, as will be the case in the experimental setup at LHCb, the angular velocity simplifies to
\begin{equation}
...
Equation \eqref{eq:spin-precession-l_cap1} therefore provides a way to measure the values of EDMs and MDMs for neutral particles by studying the change in polarization after flying through a magnetic field.
...
Thankfully, in selected cases such as the one covered in this thesis, $\vec{s}_0$ can be known by exploiting the same parity violation of weak interactions discovered in 1956 by Wu and her collaborators.
...
its mass of $\approx 1115\,\text{MeV}/c$ \cite{PDG}, the lighest among $s$-bearing baryons, meant its only viable decay channels were mediated by the flavour-changing weak interaction, giving the $\Lambda$ a much longer half-life than expected;
...
[Soddisfa tutti i requisiti: neutra, vita media, campo magnetico, polarizzazione.]
